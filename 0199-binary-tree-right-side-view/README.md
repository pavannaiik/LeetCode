<h2><a href="https://leetcode.com/problems/binary-tree-right-side-view/?envType=company&envId=oracle&favoriteSlug=oracle-six-months">199. Binary Tree Right Side View</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, imagine yourself standing on the <strong>right side</strong> of it, return <em>the values of the nodes you can see ordered from top to bottom</em>.</p>
